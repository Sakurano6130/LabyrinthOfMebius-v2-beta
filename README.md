...
## ダウンロード
[**LabyrinthOfMebius_2.4.0_win64.zip**](https://github.com/Sakurano6130/LabyrinthOfMebius-v2-beta/releases/download/v2.4.0/LabyrinthOfMebius_2.4.0_win64.zip)
...
【Special Thanksとしてお名前を載せて良い場合は、そのお名前】（載せてほしくない場合は書かなくてよいです）
（○○○）
...
## 開発用データについて
本作ではゲームバランス調整のために、
ボス戦の討伐タイムやゲームオーバー発生状況など、プレイ状況の一部を匿名で収集しています。

収集されたデータは、個人を特定できない形でクラウドに送信されます。
「誰がプレイしたか」を特定する情報は一切含まれていません。
純粋に難易度や遊びやすさの改善を目的としたものですので、ご安心ください。

---

## テスト期間中も細かいバージョンアップする可能性があります
上記、ご了承をお願いします。
バージョンアップした場合は、ゲームのタイトル画面でお知らせします。
